...
{
    $url = 'http://localhost/FantacalcioApplication/backend/api/squad_league/getSquadJoinLeague.php?id_league=' . $id_league;
...
{
    $url = 'http://localhost/FantacalcioApplication/backend/api/rosa/addPlayerToSquad.php';
...
{
    $url = 'http://localhost/FantacalcioApplication/backend/api/rosa/getNumberPlayer.php?id_squad=' . $id_squad;
