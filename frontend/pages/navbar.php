  ...
  <nav class="navbar navbar-expand-lg bg-dark" data-bs-theme="dark"> <!-- background-bootstrap-->
    <div class="container-fluid">
      <a class="navbar-brand" href="homepage.php">
        <img src="../assets/img/letter-f.png" alt="Fantacalcio" width="40" height="40">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="leghe.php">Leghe</a>
          </li>
          </li>
          <!--<li class="nav-item">
          ...
          <li class="nav-item dropdown">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="listone.php">Listone</a>
          </li>
          </li>
